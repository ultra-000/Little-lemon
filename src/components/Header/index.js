    ...
    return (
        <header>
            <div className="container mx-auto py-8 px-12 flex justify-between items-center">
                ...
                <nav ref={menuRef} className="fixed left-0 top-0 translate-x-[100%] transition-all duration-300 w-full h-screen bg-[var(--primary-color)] text-white lg:static lg:bg-inherit lg:h-auto lg:text-black lg:w-auto lg:translate-x-0">
